...
<div style="max-width:520px;margin:32px auto;background:#111318;border:1px solid #1f2235;border-radius:12px;overflow:hidden;">
  ...
  <div style="padding:28px;">
    ...
    <div style="font-size:28px;font-weight:700;color:#e8eaf2;letter-spacing:-0.5px;margin-bottom:4px;">
    ...
    <div style="display:flex;gap:12px;margin-bottom:24px;">
      <div style="flex:1;background:#0a0c10;border:1px solid #1f2235;border-radius:8px;padding:14px 16px;">
        ...
        <div style="font-size:22px;font-weight:700;color:#e8eaf2;font-family:monospace;">$${currentPrice.toFixed(2)}</div>
      </div>
      <div style="flex:1;background:#0a0c10;border:1px solid #1f2235;border-radius:8px;padding:14px 16px;">
    ...
    <a href="${process.env.VITE_APP_URL || 'https://personal-investments-41mm.vercel.app'}/watchlist"
  ...
  <div style="padding:14px 28px;border-top:1px solid #1f2235;font-size:10px;color:#545878;font-family:monospace;">
    Apex Investment Research · Personal alerts · ${new Date().toUTCString()}
  </div>
</div>
</body></html>`
}
